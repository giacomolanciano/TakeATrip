 ...
 */
public class InserimentoImmagineTappaTask extends AsyncTask<Void, Void, Void> {
    ...
    public InserimentoImmagineTappaTask(Context context, String email, String codiceViaggio, int ordine,
                                        DriveId idDrive, String urlimmagine, String condivisione){
        this.email = email;
