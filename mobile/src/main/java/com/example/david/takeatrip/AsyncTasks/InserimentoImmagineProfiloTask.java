...
public class InserimentoImmagineProfiloTask extends AsyncTask<Void, Void, Void> {
    ...
    public InserimentoImmagineProfiloTask(Context c, String emailUtente, DriveId id){
        context  = c;
        emailUser = emailUtente;
        idFile = id;
    }

    public InserimentoImmagineProfiloTask(Context c, String emailUtente, DriveId id, String url){
        context  = c;
        emailUser = emailUtente;
        idFile = id;
        urlImmagine = url;
