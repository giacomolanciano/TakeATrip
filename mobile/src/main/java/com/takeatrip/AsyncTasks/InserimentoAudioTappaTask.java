...
public class InserimentoAudioTappaTask extends AsyncTask<Void, Void, Void> {
    ...
    private final static String ADDRESS_INSERT_AUDIO_STOP = "InserimentoAudioTappa.php";

    private Context context;

    InputStream is = null;
    String result, stringaFinale = "";
    String email, codiceViaggio, urlAudio, condivisione;
    DriveId idDrive;
    int ordine;


    public InserimentoAudioTappaTask(Context context, String email, String codiceViaggio, int ordine,
                                     DriveId idDrive, String urlAudio, String condivisione) {
        this.email = email;
    ...
    protected Void doInBackground(Void... params) {
        ...
        dataToSend.add(new BasicNameValuePair("url", urlAudio));
        ...
        try {
            ...
            if (InternetConnection.haveInternetConnection(context)) {
                ...
                HttpPost httppost = new HttpPost(Constants.PREFIX_ADDRESS + ADDRESS_INSERT_AUDIO_STOP);
