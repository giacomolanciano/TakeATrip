...
public class UpdateCondivisioneContentTask extends AsyncTask<Void, Void, Void> {
    ...
    private String codiceViaggio, nuovoLivello, url;
    private InputStream is = null;
    private String result;
    private int ordine;

    public UpdateCondivisioneContentTask(Context context, String codiceViaggio, int ordine, String nuovoLivello, String url) {
    ...
    protected Void doInBackground(Void... params) {
        ...
        dataToSend.add(new BasicNameValuePair("url", url));
